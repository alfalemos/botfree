...
switch ($tlg->Text ()){
	...
	$tlg->sendMessage ([
		...
		'reply_markup' => $tlg->buildInlineKeyBoard ([
			[$tlg->buildInlineKeyboardButton ('🇧🇷 TESTE ALFA INTERNET 24HRS 🇧🇷', null, '/sshgratis')]
		])
	]);
	...
	$tlg->sendMessage ([
		'chat_id' => $tlg->ChatID (),
		'text' => 'Bot Mod @alfalemos por @alfalemos'
	]);
